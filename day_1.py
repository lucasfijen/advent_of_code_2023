...
def process_2_line(line):
    filterset = re.findall(r'(?=(\d|one|two|three|four|five|six|seven|eight|nine))', line)
...
# %%
handle_all_data(final_data, True)
# %%
preprocess('nine1')
# %%
handle_all_data(example_2_data, True)
